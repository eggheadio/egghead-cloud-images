(function () {
  ...
  */
  ...
  var _twemoji = _interopRequireDefault(twemoji);
  ...
  var TalkTemplate = function TalkTemplate(_ref) {
    ...
    var talkTitle = get_1(data.talk, "title");
    return jsx("div", {
      css: {
        width: 1280,
        height: 720,
